...
import {
  ...
  defaultStyleClasses,
} from '../src/utils/tailwind-classes.js';
...
describe('Tailwind Classes Utilities', () => {
  describe('extractTailwindClasses', () => {
    ...
    it('should handle empty style classes', () => {
      ...
      assert.deepStrictEqual(classes, defaultClasses, 'Should return default classes for empty input');
    });
  });
  ...
  describe('defaultStyleClasses', () => {
    it('should have all required style properties', () => {
      ...
      for (const prop of requiredProps) {
        ...
        assert(typeof defaultStyleClasses[prop as keyof typeof defaultStyleClasses] === 'string', 
